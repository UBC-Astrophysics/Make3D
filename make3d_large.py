...
x,y,f2,f3 = np.loadtxt("field.dat.gz", unpack=True,usecols=(0,1,9,11))
# restrict the King model to lie within a sphere of radius 2400 arcseconds
rmax=2400

# restrict the input stars within a circle of radius 30000 arcseconds
rmax2d=2400

# restrict the cumulative distribution to within 160 arcseconds
rmax2d_fit = 120
...
np.savetxt("center_3d.dat",np.transpose((x,y,z,randval,f2,f3)),fmt='%12.5f',
